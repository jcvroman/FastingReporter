...
final class HealthRepository: HealthRepositoryProtocol {
    ...
    func updateEntryCarbs(carbsList: [CarbModel]) -> [CarbModel] {
        ...
        print("DEBUG: HealthRepository.updateEntryCarbs: carbsListWork: \(carbsListWork)")
    ...
    func createFastList(carbsListCVM: [CarbViewModel]) -> [CarbViewModel] {
        ...
        // print("DEBUG: HealthRepository.createFastList: carbsListCVM: \(carbsListCVM)")
        ...
        // print("DEBUG: HealthRepository.createFastList: dateListUnique: \(dateListUnique)")
        ...
        for date in dateListUnique {
            ...
            // print("DEBUG: HealthRepository.createFastList: date: \(date)")
        }
        fastListNew = fastListNew.dropLast()

        print("DEBUG: HealthRepository.createFastList: fastListNew: \(fastListNew)")
        return fastListNew
    }
}
